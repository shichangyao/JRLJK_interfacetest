...
class Test_api_04_12(unittest.TestCase):
    '''
    用例名称：请求使用正确的炉子编号和区域编号以及sign值为1且输入start_time和end_time的范围超过24小时能正常得到最近24小时内温度数据
    用例描述：使用正确的炉子编号和区域编号以及sign值为1且输入start_time和end_time的范围超过24小时能正常得到最近24小时内温度数据
    用例编号：api_04_12
    '''
