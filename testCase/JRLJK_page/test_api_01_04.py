...
class Test_api_01_04(unittest.TestCase):
    '''
    用例名称：使用超出数据库数据的炉子编号和正确的区域编号进行请求会提示错误信息
    用例描述：使用超出数据库数据的炉子编号和正确的区域编号进行请求会提示错误信息
    用例编号：api_01_04
    '''
    ...
    def setUp(self):
        ...
        self.pasrms = Service_Layer().get_pasrms(1,3)
        self.File = "File"
