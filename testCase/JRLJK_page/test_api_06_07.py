...
class Test_api_06_07(unittest.TestCase):
    '''
    用例名称：请求使用正确的炉子编号和页码可以正常得到近两个小时某一页的报警数据
    用例描述：请求使用正确的炉子编号和页码可以正常响应且拿到近两小时某一页的报警数据
    用例编号：api_06_07
    '''
    ...
    def setUp(self):
        ...
        self.pasrms = {"furnaceNo":self.pasrms_furnaceNo,"page": self.page}
